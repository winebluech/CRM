...
CREATE TABLE `productinfo`  (
  ...
  `contactpersion` varchar(32) CHARACTER ，
  `phone` varchar(32) CHARACTER  ，
  `is_delete` varchar(32) CHARACTER  SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL，
 `remark` varchar(32) CHARACTER ，
